...
export function NoteCard(props: NoteCardProps){
  ...
  <Dialog.Root>
    ...
    <Dialog.Portal>
      ...
      <Dialog.Content className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 max-w-[649px] w-full h-[60vh] bg-slate-700 rounded-md flex flex-col outline-none">
