...
export function NewNoteCards({oneCreated}: NewNoteCardsPorps){
  ...
  return(
    ...
    <Dialog.Portal>
      ...
      <Dialog.Content className=" overflow-hidden fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 max-w-[649px] w-full h-[60vh] bg-slate-700 rounded-md flex flex-col outline-none">
